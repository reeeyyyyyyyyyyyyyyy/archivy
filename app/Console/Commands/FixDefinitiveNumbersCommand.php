...
class FixDefinitiveNumbersCommand extends Command
{
    protected $signature = 'fix:definitive-numbers {--dry-run : Show what would be fixed without making changes}';
    protected $description = 'Fix definitive numbers to be sequential per problem and year';
    ...
    public function handle()
    {
        ...
        $this->info('🔧 Fixing Definitive Numbers');
        $this->info('==========================');
