...
class TelegramSearchCommand extends Command
{
    protected $signature = 'telegram:search {query}';
    protected $description = 'Search archives via Telegram bot';
    ...
    public function handle()
    {
        ...
        try {
            $archives = Archive::where('index_number', 'like', "%{$query}%")
            ...
            $this->error('Failed to send search results to Telegram');
        }
    }
}
