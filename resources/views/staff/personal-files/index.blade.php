<x-app-layout>
    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <form method="GET" action="{{ route('staff.personal-files.index') }}" class="space-y-4">
                <!-- Search Row -->
                <div class="flex gap-4">
                    ...
                    @if(request('search') || request('category_filter'))
                        <a href="{{ route('staff.personal-files.index') }}"
                            class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
            ...
            function confirmDeleteArchive(archiveId, indexNumber, description) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = `/staff/personal-files/${archiveId}`;
