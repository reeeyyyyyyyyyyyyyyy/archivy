<x-app-layout>
    ...
    <div class="p-6 space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-orange-50 to-teal-50 px-6 py-4 border-b border-gray-200">
                ...
                <form id="generateForm" class="space-y-8">
                    ...
                    <div class="flex justify-end pt-4">
                        <button type="submit" id="generateBtn"
                            class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-600 to-teal-600 hover:from-orange-700 hover:to-teal-700 text-white rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg">
