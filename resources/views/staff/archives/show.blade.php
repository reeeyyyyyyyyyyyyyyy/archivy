    ...
    <div class="p-6 space-y-6">
        ...
        <div class="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-lg">{{ $archive->description }}</p>
                </div>
                <div class="text-right">
                    ...
                    <p class="text-emerald-100 text-sm mt-2">Status Saat Ini</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('staff.archives.edit', $archive) }}"
                    class="inline-flex items-center px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition-colors shadow-sm">
            ...
            function confirmDeleteArchive(indexNumber, description) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = '{{ route('staff.archives.destroy', $archive) }}';
