<x-app-layout>
    ...
    <div class="bg-white shadow-sm border-b px-6 py-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Arsip</h1>
                <p class="text-sm text-gray-600 mt-1">Perbarui informasi arsip: {{ $archive->index_number }}</p>
            </div>
    ...
    <div class="p-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <form action="{{ route('staff.archives.update', $archive) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
