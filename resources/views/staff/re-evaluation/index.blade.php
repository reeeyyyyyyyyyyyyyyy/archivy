        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('staff.re-evaluation.evaluated') }}"
    ...
    @push('scripts')
        ...
        <script>
            ...
            function applyFilters() {
                ...
                $.ajax({
                    url: '{{ route('staff.re-evaluation.get-archives') }}',
                    method: 'GET',
                    data: formData,
                    processData: false,
                    contentType: false,
                ...
                archives.forEach(function(archive, index) {
                    const row = `
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="/staff/re-evaluation/${archive.id}" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                    <i class="fas fa-eye mr-1"></i>Detail
                                </a>
                            </td>
                        </tr>
            ...
            function bulkStatusChange() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // Call backend
                        $.ajax({
                            url: '{{ route('staff.re-evaluation.bulk-update') }}',
                            method: 'POST',
                            data: {
