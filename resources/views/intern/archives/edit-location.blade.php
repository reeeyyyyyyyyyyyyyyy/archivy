<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('staff.archives.update-location', $archive) }}"
                        ...
                        <div>
                            <label for="rack_id" class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-warehouse mr-2 text-emerald-500"></i>Pilih Rak
                            </label>
    ...
    @push('scripts')
        ...
        <script>
            ...
            // Auto-sync function for real-time storage box counts
            function autoSyncStorage() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Update visual grid with fresh data
                        updateVisualGrid();
                    }
                })
                .catch(error => {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Start auto-sync every 1 second for real-time data
