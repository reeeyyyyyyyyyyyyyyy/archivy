        ...
        <script>
            $(document).ready(function() {
                ...
                function updateNumberingExample(classificationId) {
                    ...
                    if (!classificationId) {
                        exampleDiv.html(`
                            <strong>Format JRA:</strong> Masukkan Nomor Arsip Sesuai Pada Arsip yang Akan di Input (contoh: INT/LAP/015/2025)<br>
                        `);
                        indexNumberInput.attr('placeholder', 'Contoh: INT/LAP/015/2025');
                        return;
                    }
