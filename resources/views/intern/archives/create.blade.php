<x-app-layout>
    ...
    <div class="p-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            @endif
                <form action="{{ route('intern.archives.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                    @csrf
                    ...
                    <div class="md:col-span-2 border-b border-gray-200 pb-6">
                    ...
                    <div id="manual_input_section" class="md:col-span-2 border-b border-gray-200 pb-6 hidden">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    ...
                    <div id="retention_section" class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
