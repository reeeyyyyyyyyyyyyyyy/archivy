                ...
                <div class="text-left space-y-4">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <ul class="list-disc ml-5 text-sm text-green-700 space-y-1">
                            ...
                            <li><strong>Status Box:</strong> Lihat status box secara real-time</li>
                            <li><strong>Kapasitas:</strong> Monitor kapasitas box dan utilisasi rak</li>
                            <li><strong>Informasi Rak:</strong> Lihat detail informasi rak penyimpanan</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <ul class="list-disc ml-5 text-sm text-yellow-700 space-y-1">
                            <li><strong>Read Only:</strong> Intern hanya bisa melihat, tidak bisa mengubah status</li>
                            ...
                            <li><strong>Monitoring:</strong> Fokus pada monitoring dan observasi</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        ...
                        <ul class="list-disc ml-5 text-sm text-purple-700 space-y-1">
                            ...
                            <li>Perhatikan kapasitas dan utilisasi rak untuk efisiensi</li>
                            <li>Gunakan fitur ini untuk belajar sistem penyimpanan arsip</li>
                        </ul>
                    </div>
                </div>
            `;
