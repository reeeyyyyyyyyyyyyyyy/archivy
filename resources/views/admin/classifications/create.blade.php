                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div>
                        ...
                        <select name="nasib_akhir" id="nasib_akhir"
                            ...
                            <option value="Musnah" {{ old('nasib_akhir') == 'Musnah' ? 'selected' : '' }}>Musnah
                            </option>
                            <option value="Permanen" {{ old('nasib_akhir') == 'Permanen' ? 'selected' : '' }}>Permanen
                            </option>
                            <option value="Dinilai Kembali"
                                {{ old('nasib_akhir') == 'Dinilai Kembali' ? 'selected' : '' }}>Dinilai Kembali
                            </option>
                            <option value="Masuk ke Berkas Perseorangan"
                                {{ old('nasib_akhir') == 'Masuk ke Berkas Perseorangan' ? 'selected' : '' }}>Masuk ke Berkas Perseorangan
                            </option>
                        </select>
                        @error('nasib_akhir')
                            <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
