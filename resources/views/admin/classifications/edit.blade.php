    ...
    <div class="bg-white shadow-sm border-b px-6 py-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Perbarui informasi klasifikasi: {{ $classification->code }} - {{ $classification->nama_klasifikasi }}</p>
            </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" name="nama_klasifikasi" id="nama_klasifikasi"
                               class="w-full bg-white border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4"
                               value="{{ old('nama_klasifikasi', $classification->nama_klasifikasi) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="retention_aktif" id="retention_aktif"
                                   class="w-full bg-white border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4"
                                   value="{{ old('retention_aktif', $classification->retention_aktif) }}" required min="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="retention_inaktif" id="retention_inaktif"
                                   class="w-full bg-white border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4"
                                   value="{{ old('retention_inaktif', $classification->retention_inaktif) }}" required min="0"
                                   placeholder="Masukkan jumlah tahun">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div>
                        ...
                        <select name="nasib_akhir" id="nasib_akhir"
                            ...
                            <option value="Musnah" {{ old('nasib_akhir', $classification->nasib_akhir) == 'Musnah' ? 'selected' : '' }}>Musnah</option>
                            <option value="Permanen" {{ old('nasib_akhir', $classification->nasib_akhir) == 'Permanen' ? 'selected' : '' }}>Permanen</option>
                        </select>
                        ...
                        <div class="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <p class="text-sm text-blue-700">
                                ...
                                <strong>Catatan:</strong> Perubahan nasib akhir akan mempengaruhi semua arsip dalam klasifikasi ini.
                            </p>
                        </div>
                    </div>
                </div>
