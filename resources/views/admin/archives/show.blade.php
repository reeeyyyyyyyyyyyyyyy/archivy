            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-sm font-medium text-gray-600">Nomar Berkas</span>
                        </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <p class="text-lg font-semibold text-gray-900">
                            @if($archive->manual_tingkat_perkembangan)
                                <span class="text-blue-600">{{ $archive->manual_tingkat_perkembangan }}</span>
                ...
                <div class="mt-6 bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm font-medium text-gray-600">Tingkat Kerahasiaan (SKKD)</span>
                    </div>
                    <p class="text-lg font-semibold text-gray-900">
                        {{ $archive->skkd }}
                        @if($archive->skkd === 'Rahasia' || $archive->skkd === 'Sangat Rahasia')
                            <span class="text-xs text-red-500 ml-2">
                                <i class="fas fa-exclamation-triangle"></i> Akses Terbatas
                            </span>
                        @endif
                    </p>
                </div>
