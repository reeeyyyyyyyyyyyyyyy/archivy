            ...
            <form action="{{ route('admin.archives.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                ...
                                <p><strong>Kategori LAINNYA:</strong> Input manual untuk semua field kecuali SKKD (tetap dropdown), perhitungan retensi tetap otomatis</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-1 text-sm text-orange-700">
                                    <p><strong>Isilah Secara Manual:</strong> Retensi aktif/inaktif, nasib akhir, nomor arsip lengkap</p>
                                    {{-- <p><strong>Yang Otomatis:</strong> SKKD (dropdown), perhitungan tanggal retensi</p> --}}
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- SKKD -->
                        <div>
                            <label for="skkd" class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-shield-alt mr-2 text-red-500"></i>SKKD (Sifat Keamanan)
                            </label>
                            <select name="skkd" id="skkd" 
                                class="w-full bg-white border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4" 
                                required>
                                <option value="">Pilih SKKD...</option>
                                <option value="SANGAT RAHASIA" {{ old('skkd') == 'SANGAT RAHASIA' ? 'selected' : '' }}>
                                    <span class="text-red-600 font-medium">SANGAT RAHASIA</span>
                                </option>
                                <option value="TERBATAS" {{ old('skkd') == 'TERBATAS' ? 'selected' : '' }}>
                                    <span class="text-yellow-600 font-medium">TERBATAS</span>
                                </option>
                                <option value="RAHASIA" {{ old('skkd') == 'RAHASIA' ? 'selected' : '' }}>
                                    <span class="text-orange-600 font-medium">RAHASIA</span>
                                </option>
                                <option value="BIASA/TERBUKA" {{ old('skkd') == 'BIASA/TERBUKA' ? 'selected' : '' }}>
                                    <span class="text-green-600 font-medium">BIASA/TERBUKA</span>
                                </option>
                            </select>
                            @error('skkd')
                                <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                ...
                function updateRetentionInfoFromClassification(classificationId) {
                    ...
                    if (isManual) {
                        ...
                        exampleDiv.html(`
                            ...
                            <small class="text-red-600">⚠️ Isi manual: Retensi aktif/inaktif, nasib akhir | SKKD tetap dropdown</small>
                        `);
