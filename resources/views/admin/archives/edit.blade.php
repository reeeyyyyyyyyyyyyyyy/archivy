                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="skkd" id="skkd"
                                ...
                                <option value="SANGAT RAHASIA" {{ old('skkd', $archive->skkd) == 'SANGAT RAHASIA' ? 'selected' : '' }}>SANGAT RAHASIA</option>
                                <option value="TERBATAS" {{ old('skkd', $archive->skkd) == 'TERBATAS' ? 'selected' : '' }}>TERBATAS</option>
                                <option value="RAHASIA" {{ old('skkd', $archive->skkd) == 'RAHASIA' ? 'selected' : '' }}>RAHASIA</option>
                                <option value="BIASA/TERBUKA" {{ old('skkd', $archive->skkd) == 'BIASA/TERBUKA' ? 'selected' : '' }}>BIASA/TERBUKA</option>
                            </select>
                            @error('skkd')
                                <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
