        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                @foreach($statuses as $key => $title)
                    ...
                    <a href="{{ 
                        auth()->user()->isAdmin() ? route('admin.archives.export-form', $key) : 
                        (auth()->user()->isStaff() ? route('staff.export-form', $key) : route('intern.export-form', $key))
                    }}" 
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Export Current Year -->
                    <form action="{{ 
                        auth()->user()->isAdmin() ? route('admin.export.process') : 
                    ...
                    <form action="{{ 
                        auth()->user()->isAdmin() ? route('admin.export.process') : route('staff.export.process')
                    }}" method="POST" class="inline">
                        @csrf
                        <input type="hidden" name="status" value="all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-gray-600 space-y-1">
                            ...
                            <li><i class="fas fa-filter text-blue-500 mr-2"></i>Filter berdasarkan pembuat</li>
